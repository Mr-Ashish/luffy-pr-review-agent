#!/usr/bin/env python3
"""Phase 1: Convert a Luffy review Markdown (+ optional sidecars) to OpenUI Lang.
...
def build_openui(
    ...
    *,
    ...
    lines.append(
        f'metaText = TextContent("Luffy structured review rendered via OpenUI Lang '
...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument("--review", type=Path, required=True, help="Luffy review.md path")
    ...
    p.add_argument("--title", default="Luffy Review", help="Card header title")
