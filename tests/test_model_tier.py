...
class SelectModelTests(unittest.TestCase):
    ...
    def test_off_explicit(self):
        r = _mod.select_model(mode="off", luffy_model="openai/gpt-5-mini")
    ...
    def test_auto_uses_luffy_model_as_full(self):
        r = _mod.select_model(
            mode="auto",
            luffy_model="anthropic/claude-sonnet-4",
...
class CliTests(unittest.TestCase):
    def test_select_cli_auto_tiny(self):
        env = {**os.environ, "LUFFY_MODEL_TIER": "auto"}
        env.pop("LUFFY_MODEL", None)
...
class WiringTests(unittest.TestCase):
    def test_run_hermes_wires_model_tier(self):
        ...
        self.assertIn("LUFFY_MODEL_TIER", text)
    ...
    def test_workflow_exports_vars(self):
        ...
        self.assertIn("LUFFY_MODEL_TIER", text)
        self.assertIn("LUFFY_MODEL_CHEAP", text)
