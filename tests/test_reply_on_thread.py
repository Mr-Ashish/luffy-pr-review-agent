...
class Markers(unittest.TestCase):
    def test_is_luffy_inline(self):
        self.assertTrue(_mod.is_luffy_inline_body("x\n\n<!-- luffy-inline -->\n"))
        self.assertFalse(_mod.is_luffy_inline_body("ordinary review comment"))
    ...
    def test_index_roots(self):
        ...
        roots = _mod.index_luffy_roots(existing)
...
class Match(unittest.TestCase):
    def setUp(self):
        os.environ["LUFFY_REPLY_ON_THREAD"] = "1"

    def tearDown(self):
        os.environ.pop("LUFFY_REPLY_ON_THREAD", None)
        os.environ.pop("LUFFY_REPLY_MATCH", None)

    def test_path_line_exact(self):
        roots = [
            {"id": 1, "path": "a.go", "line": 10, "is_luffy": True, "is_root": True, "body": ""},
            {"id": 2, "path": "a.go", "line": 20, "is_luffy": True, "is_root": True, "body": ""},
        ]
    ...
    def test_plan_split(self):
        ...
        self.assertIn("luffy-inline-reply", out["replies"][0]["body"])

    def test_disabled(self):
        os.environ["LUFFY_REPLY_ON_THREAD"] = "0"
...
class PostFixture(unittest.TestCase):
    def test_fixture_post(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            os.environ["LUFFY_REPLY_FIXTURE"] = str(fix)
        ...
        os.environ.pop("LUFFY_REPLY_FIXTURE", None)
        os.environ.pop("LUFFY_REPLY_ON_THREAD", None)
