...
class GroupAndRender(unittest.TestCase):
    ...
    def test_section_marker(self):
        ...
        self.assertIn("<!-- luffy-mermaid -->", sec)
...
"""
        ...
        self.assertIn("<!-- luffy-mermaid -->", out)
