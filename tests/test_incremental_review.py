...
class Marker(unittest.TestCase):
    def test_parse_full(self):
        p = _mod.parse_marker("<!-- luffy-review pr=12 run=99 head=abcdef1234567890 -->")
        ...
        comments = [
            {
                ...
                "body": "<!-- luffy-review pr=5 head=aaa111bbb222 -->\n**Verdict:** APPROVE",
            },
            {
                "id": 2,
                "created_at": "2026-01-02T00:00:00Z",
                "body": "<!-- luffy-review pr=5 head=ccc333ddd444 -->\n**Verdict:** COMMENT",
            },
        ]
...
class Plan(unittest.TestCase):
    def setUp(self):
        os.environ["LUFFY_INCREMENTAL"] = "1"

    def tearDown(self):
        os.environ.pop("LUFFY_INCREMENTAL", None)

    def test_disabled(self):
        os.environ["LUFFY_INCREMENTAL"] = "0"
...
class AssembleFixture(unittest.TestCase):
    def test_rewrite_diff(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            os.environ["LUFFY_INCREMENTAL_FIXTURE"] = str(fp)
            try:
                d = _mod.assemble(
                    repo="acme/x",
                    pr=9,
                ...
                os.environ.pop("LUFFY_INCREMENTAL_FIXTURE", None)
                os.environ.pop("LUFFY_INCREMENTAL", None)
            self.assertEqual(d["mode"], "incremental")
