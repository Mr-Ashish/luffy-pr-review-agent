...
Your previous reply used **0 tool turns** on a multi-file code PR (**14** files). That is incomplete for an agentic review: do **not** finalize from the diff text alone.
