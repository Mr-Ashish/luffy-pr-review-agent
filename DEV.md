...
- **H16 lesson:** fixing `hermes -z` argv does **not** guarantee tool use — gpt-4.1-mini can still single-shot with `tool_turns=0`; F45 remains the honesty gate; **F49** is the recovery attempt; H18 (hard tool nudge) is backlog if soft re-prompt stays 0.
