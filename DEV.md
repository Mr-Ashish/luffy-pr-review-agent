...
- **F64 durable fp-rules self-learn:** structured `.luffy/fp-rules.json` (schema v1) written on F62 update, preloaded with MEMORY, carried in hub-payload + local ingest merge. Thin local self-learn loop; multi-tenant federation still deferred.
