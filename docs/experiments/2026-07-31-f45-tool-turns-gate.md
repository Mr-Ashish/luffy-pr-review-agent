...
- F44 run: `.luffy-out-e2e-pr2-f44/` · `tool_turns=0` · score 25/50
...
- `install-luffy.sh` runtime allowlist
...
python3 scripts/tool_turns_gate.py apply \
  --review .luffy-out-e2e-pr2-f44/review-2.md \
...
| `LUFFY_TOOL_TURNS_GATE_VERDICTS` | `APPROVE` | which verdicts get rewritten |
